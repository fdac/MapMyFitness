...
def thread_proc(client_id, client_secret, thread_id, user_array):
  ...
  for line in sys .stdin:
    ...
    if (user_doc == ''):
      print 'Received empty string for user doc, continuing' + userId
      continue
    if (user_doc != []):
...
'scfmbawtvvcgny7rnnvnvzuwy84p9p2z',
'vcgmh4xc7xnp7ddmr39mz8e8qcw9athf',
'5qpn46js8z762ftj9crnrqrqbxn8kgtf',
'brb2n4nc42zwmgxxcpgwvbhsjygcqz8f'
]
