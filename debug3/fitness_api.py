...
class FitnessApi:
  ...
  def get_workouts_doc( self, userId ):
    workouts_doc = { 'userId' : userId, 'workouts': [] }
    request_url = 'https://oauth2-api.mapmyapi.com/v7.0/workout/?user=%2Fv7.0%2Fuser%2F' + str(userId) + '%2F'
    while request_url:
      workouts_reponse = self.request( request_url )
      workouts = workouts_reponse['_embedded']['workouts']
